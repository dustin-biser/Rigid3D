...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/LoadMeshObj-Example
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/LoadMeshObj-Example
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/LoadMeshObj-Example
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/LoadMeshObj-Example
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking LoadMeshObj-Example
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning LoadMeshObj-Example
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/LoadMeshObj-Example.o: ../src/examples/LoadMeshObj-Example.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
